...
/*
 * ILI9881D panel driver (original v1.4.1 code, exported as ili9881x_data)
 *
...
static int ili9881d_prepare(struct drm_panel *panel)
{
	...
	IILI9881_COMMAND(0x4C,0xA4);
	IILI9881_COMMAND(0x18,0xF4);

	ILI9881_PAGE(0x04);
	IILI9881_COMMAND(0x5D,0xAF);
	IILI9881_COMMAND(0x5E,0xAF);
	IILI9881_COMMAND(0x60,0x9B);
	IILI9881_COMMAND(0x62,0x9B);
	IILI9881_COMMAND(0x82,0x38);
	IILI9881_COMMAND(0x84,0x38);
	IILI9881_COMMAND(0x86,0x18);
	IILI9881_COMMAND(0x66,0xC4);
	IILI9881_COMMAND(0xC1,0xF0);
	IILI9881_COMMAND(0x70,0x60);
	IILI9881_COMMAND(0x71,0x00);
	IILI9881_COMMAND(0x5B,0x33);
	IILI9881_COMMAND(0x6C,0x10);
	IILI9881_COMMAND(0x77,0x03);
	IILI9881_COMMAND(0x7B,0x02);

	ILI9881_PAGE(0x01);
	IILI9881_COMMAND(0xF0,0x00);
	IILI9881_COMMAND(0xF1,0xC8);

	ILI9881_PAGE(0x05);
	IILI9881_COMMAND(0x22,0x3A);
...
/* Exported as ili9881x_data so mipi_dsi_drv.c can reference it */
